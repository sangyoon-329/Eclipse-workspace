				...
				<form method="post" enctype="application/x-www-form-urlencoded">
					...
					<div class="form-group">
						...
						<input 
							...
							placeholder="거래처이름(*)"
							value="${buyer.buyerName }"><span class="text-danger">${errors.buyerName }</span>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" id="buyerTelext" name="buyerTelext"
							maxlength="2"
							class="form-control" placeholder="내선번호" value="${buyer.buyerTelext }">
					</div>
					<div>
